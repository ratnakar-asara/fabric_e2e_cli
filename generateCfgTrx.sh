...
function generateCerts (){
	...
	echo
	cp ./crypto-config/peerOrganizations/org1.example.com/msp/signcerts/ca.org1.example.com-cert.pem ./crypto-config/peerOrganizations/org1.example.com/msp/admincerts/
	cp ./crypto-config/peerOrganizations/org2.example.com/msp/signcerts/ca.org2.example.com-cert.pem ./crypto-config/peerOrganizations/org2.example.com/msp/admincerts/
}
